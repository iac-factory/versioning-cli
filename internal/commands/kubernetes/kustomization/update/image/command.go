...
var Command = &cobra.Command{
	...
	Aliases:    []string{"img"},
	SuggestFor: nil,
	Short:      "Updates a Kustomization manifest's image directive with a new tag and name",
	Long:       "Updates a Kustomization manifest's Kustomization.images[0].newName and Kustomization.images[0].newTag according to the Kustomization.images[0].name identifier.",
